var Gritter = function () {
    ...
    $('#project-regular').click(function(){
    ...
    $('#project-without-image').click(function(){
    ...
    $('#project-gritter-light').click(function(){

        $.gritter.add({
            // (string | mandatory) the heading of the notification
            title: 'This is a Light Notification',
            // (string | mandatory) the text inside the notification
            text: 'Just project a "gritter-light" class_name to your $.gritter.project or globally to $.gritter.options.class_name',
